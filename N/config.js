...
function Record(options) {
   ...
   */
  this.prototype.getScriptingContext = function (options) {
  };
  
  /**
   * provide scripting context for records
   */
  this.prototype.eventHandlerModules = function (options) {
  };
   ...
   */
  this.prototype.getActions = function (options) {
  };
  ...
  this.prototype.saveAndFetch = function (options) {
  };
