...
export interface log {
   ...
   */
  debug(options: { title: any, details?: any }): void
   ...
   * @param {*} [options.details] The details of the message
   */
  audit(options: { title: any, details?: any }): void
   ...
   * @param {*} [options.details] The details of the message
   */
  error(options: { title: any, details?: any }): void
   ...
   * @param {*} [options.details] The details of the message
   */
  emergency(options: { title: any, details?: any }): void
